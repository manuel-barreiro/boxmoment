...
export default function Navbar() {
  ...
  return (
        <nav className='fixed top-0 right-0 w-full h-32 z-[1000] bg-white flex justify-between items-center py-5 px-10 shadow-xl font-secondary text-lg font-semibold text-darkNight '>
