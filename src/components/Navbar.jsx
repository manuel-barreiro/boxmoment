        ...
        <nav className='fixed top-0 right-0 w-full h-32 z-100 bg-white flex justify-between items-center py-5 px-10 shadow-xl font-secondary text-lg font-semibold text-darkNight '>
            ...
            <ul className={`md:hidden pb-8 absolute bg-white z-[-10] left-0 w-full pl-10 transition-all duration-500 ease-in-out ${open ? 'top-32' : 'top-[-690px]'} shadow-lg`}>
                {
                    ...
                    <li className='my-7 font-semibold'>
                        <a href={link.link} onClick={handleMenu} className='hover:text-xmasRed hover:scale-105 hover:underline underline-offset-8 decoration-xmasRed ease-in-out duration-300 '>{link.name}</a>
                    </li>))
                }
            ...
            <div className='hidden md:block basis-5/12'>
                <ul className='flex justify-evenly items-center'>
                    ...
                    <li className='shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] rounded-full bg-[#ffc51a] px-4 py-1 font-black  hover:scale-105 hover:shadow-[6.0px_10.0px_10.0px_rgba(0,0,0,0.38)] ease-in-out duration-300'><a href="https://wa.me/+5491162801006" target='_blank'>Solicitar presupuesto</a></li>
                </ul>
            </div>
        </nav>
  )
