...
const WhoAreWe = () => {
  return (
    <section class="text-gray-600 font-primary px-10 md:px-32 py-24 bg-[#ebebeb]">
      <div class="mx-auto flex flex-wrap">
        <div class="flex flex-wrap -mx-4 mt-auto mb-auto lg:w-1/2 sm:w-2/3 content-start sm:pr-10">
          <div class="w-full sm:p-4 px-4 mb-6">
            <h1 class="font-extrabold text-3xl md:text-4xl mb-8 text-darkNight underline decoration-4 decoration-wavy underline-offset-8">¿QUIÉNES SOMOS?</h1>
