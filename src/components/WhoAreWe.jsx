    ...
    <section name='quienesSomos' className="w-full h-full bg-[url('/images/backgrounds/waves1Mobile.svg')] md:bg-[url('/images/backgrounds/waves1.svg')] bg-center bg-cover py-20 md:py-28 px-8 md:px-32 font-primary flex flex-col gap-6">
      ...
      <div className="flex flex-col xl:flex-row justify-evenly gap-4">
          <div className="xl:basis-1/2 h-auto xl:h-80 flex flex-col gap-5 items-start p-6">
                ...
                className="text-3xl md:text-5xl font-extrabold text-center">¿Quiénes somos?</motion.h3>
                <motion.p 
                variants={textAnimationVariants}
                initial="initial"
                whileInView="animate"
                ...
                className="text-justify font-secondary font-bold leading-relaxed">Box Moment lleva 4 años de trayectoria en el mercado, brindando la mayor <span className="font-extrabold">comodidad</span> y <span className="font-extrabold">servicio</span> a nuestros clientes en épocas festivas. </motion.p>
                <motion.p 
                variants={textAnimationVariants}
                initial="initial"
                whileInView="animate"
      ...
      <div>
        ...
        viewport={{ once: true }}
        transition= {{ duration: 0.1, delay: 0.5}} 
        className="text-justify font-secondary font-bold p-6 -mt-4 leading-relaxed">
